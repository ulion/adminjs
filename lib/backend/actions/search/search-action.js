...
const SearchAction = {
  ...
  handler: async (request, response, context) => {
    ...
    const titlePropertyName = (query === null || query === void 0 ? void 0 : query.searchProperty) ?? decorated.searchProperty().name();

    const {
      sortBy = ((_decorated$options = decorated.options) === null || _decorated$options === void 0 ? void 0 : (_decorated$options$so = _decorated$options.sort) === null || _decorated$options$so === void 0 ? void 0 : _decorated$options$so.sortBy) || (query === null || query === void 0 ? void 0 : query.searchProperty) || decorated.titleProperty().name(),
      direction = 'asc',
