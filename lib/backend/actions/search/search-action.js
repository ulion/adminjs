...
const SearchAction = {
  ...
  handler: async (request, response, context) => {
    var _request$query, _decorated$options, _decorated$options$so, _request$query2;
    ...
    const titlePropertyName = ((_request$query = request.query) === null || _request$query === void 0 ? void 0 : _request$query.searchProperty) ?? decorated.searchProperty().name();

    const {
      sortBy = ((_decorated$options = decorated.options) === null || _decorated$options === void 0 ? void 0 : (_decorated$options$so = _decorated$options.sort) === null || _decorated$options$so === void 0 ? void 0 : _decorated$options$so.sortBy) || ((_request$query2 = request.query) === null || _request$query2 === void 0 ? void 0 : _request$query2.searchProperty) || decorated.titleProperty().name(),
      direction = 'asc',
